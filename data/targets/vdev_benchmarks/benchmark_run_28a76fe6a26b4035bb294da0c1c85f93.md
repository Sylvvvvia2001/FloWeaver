...
- Run ID: `28a76fe6a26b4035bb294da0c1c85f93`
- Case Count: `56`
...
| vdev_leaving_home_safety_check_01 | Morning and Leaving Home Routines | ok | 10 | 6 | 0 | yes |
| vdev_arrival_comfort_preparation_01 | Coming Home and Evening Comfort Routines | ok | 10 | 6 | 0 | yes |
| vdev_dinner_home_mode_01 | Coming Home and Evening Comfort Routines | ok | 10 | 6 | 0 | yes |
| vdev_night_shutdown_01 | Night and Energy Monitoring Routines | ok | 11 | 6 | 0 | yes |
| vdev_overnight_health_safety_monitoring_01 | Night and Energy Monitoring Routines | ok | 8 | 6 | 0 | yes |
| vdev_weekend_whole_home_snapshot_01 | Night and Energy Monitoring Routines | ok | 16 | 6 | 0 | yes |
| vdev_party_preparation_01 | Coming Home and Evening Comfort Routines | ok | 10 | 6 | 0 | yes |
| vdev_party_scene_activation_01 | Scene Activation and Comfort Control Routines | error | - | - | - | no |
| vdev_movie_night_blackout_01 | Scene Activation and Comfort Control Routines | ok | 18 | 6 | 0 | yes |
...
| vdev_arrive_home_lighting_climate_prep_01 | Coming Home and Evening Comfort Routines | ok | 13 | 6 | 0 | yes |
| vdev_leave_home_safety_energy_sweep_01 | Morning and Leaving Home Routines | ok | 13 | 6 | 0 | yes |
| vdev_good_morning_whole_floor_readiness_01 | Morning and Leaving Home Routines | ok | 11 | 6 | 0 | yes |
| vdev_bedtime_lockdown_routine_01 | Night and Energy Monitoring Routines | ok | 12 | 6 | 0 | yes |
| vdev_rain_coming_indoor_adjustment_01 | Weather and Contextual Adjustment Routines | ok | 8 | 6 | 0 | yes |
| vdev_weekend_whole_home_snapshot_extended_01 | Whole-Home Survey and Audit Routines | ok | 19 | 6 | 0 | yes |
| vdev_dinner_preparation_readiness_01 | Coming Home and Evening Comfort Routines | ok | 9 | 6 | 0 | yes |
| vdev_party_preparation_ambience_check_01 | Coming Home and Evening Comfort Routines | ok | 11 | 6 | 0 | yes |
| vdev_workday_departure_office_zone_shutdown_01 | Morning and Leaving Home Routines | ok | 8 | 6 | 0 | yes |
| vdev_kids_room_comfort_safety_snapshot_01 | Family Care and Room-Level Snapshot Routines | ok | 10 | 6 | 0 | yes |
| vdev_elderly_care_daily_check_01 | Family Care and Room-Level Snapshot Routines | ok | 9 | 6 | 0 | yes |
| vdev_laundry_utility_room_sweep_01 | Family Care and Room-Level Snapshot Routines | ok | 7 | 6 | 0 | yes |
| vdev_air_quality_recovery_routine_01 | Family Care and Room-Level Snapshot Routines | ok | 9 | 6 | 0 | yes |
| vdev_vacation_mode_house_sweep_01 | Whole-Home Survey and Audit Routines | ok | 18 | 6 | 0 | yes |
| vdev_homecoming_security_ambience_merge_01 | Scene Activation and Comfort Control Routines | ok | 7 | 6 | 0 | yes |
| vdev_school_night_quiet_hours_01 | Night and Energy Monitoring Routines | ok | 10 | 6 | 0 | yes |
| vdev_rainy_commute_preparation_01 | Weather and Contextual Adjustment Routines | ok | 6 | 6 | 0 | yes |
| vdev_energy_hvac_audit_expanded_01 | Whole-Home Survey and Audit Routines | ok | 7 | 6 | 0 | yes |
| vdev_whole_home_ble_safety_sweep_01 | Household Stress and Abnormality Routines | ok | 15 | 6 | 0 | yes |
| vdev_cloud_burst_living_conditions_snapshot_01 | Whole-Home Survey and Audit Routines | ok | 11 | 6 | 0 | yes |
| vdev_morning_wakeup_readiness_profile_01 | Profile Coverage - Morning Routines | ok | 12 | 6 | 0 | yes |
| vdev_whole_family_morning_comfort_snapshot_01 | Profile Coverage - Morning Routines | error | - | - | - | no |
| vdev_school_day_quiet_start_check_01 | Profile Coverage - Morning Routines | ok | 9 | 6 | 0 | yes |
...
| vdev_arrival_home_preparation_profile_01 | Profile Coverage - Arrival and Departure Routines | ok | 9 | 6 | 0 | yes |
| vdev_vacation_departure_final_audit_01 | Profile Coverage - Arrival and Departure Routines | error | - | - | - | no |
| vdev_come_home_security_comfort_merge_01 | Profile Coverage - Arrival and Departure Routines | ok | 10 | 6 | 0 | yes |
| vdev_bedtime_lockdown_profile_01 | Profile Coverage - Evening and Overnight Routines | ok | 13 | 6 | 0 | yes |
| vdev_kids_room_night_safety_check_01 | Profile Coverage - Evening and Overnight Routines | ok | 7 | 6 | 0 | yes |
...
| vdev_whole_home_energy_hvac_audit_profile_01 | Profile Coverage - Monitoring and Audit Routines | ok | 17 | 6 | 0 | yes |
| vdev_indoor_air_climate_audit_01 | Profile Coverage - Monitoring and Audit Routines | error | - | - | - | no |
| vdev_security_presence_fabric_snapshot_01 | Profile Coverage - Monitoring and Audit Routines | ok | 11 | 6 | 0 | yes |
...
| vdev_cloud_burst_living_conditions_snapshot_profile_01 | Profile Coverage - Realistic Stress Routines | ok | 14 | 6 | 0 | yes |
...
The first 4 BLE actions run serially to avoid shared-radio conflicts. Cloud reads are grouped by provider and endpoint: tuya groups 2 actions into 1 chunks. Local reads overlap other reads in batch_005. Writeback follows lane updates and then the overall update: batch_008 -> batch_009. M6 found no counterexamples in the evaluated replay scenarios.
...
- Final Schedule: `16` batches, max `3` parallel groups in one batch
- M6 Evidence: strict `6`, tolerant `6`, counterexamples `0`
...
The first 8 BLE actions run serially to avoid shared-radio conflicts. Cloud reads are grouped by provider and endpoint: tuya groups 2 actions into 1 chunks. Local reads overlap other reads in batch_010. Writeback follows lane updates and then the overall update: batch_014 -> batch_015. M6 found no counterexamples in the evaluated replay scenarios.
...
The first 6 BLE actions run serially to avoid shared-radio conflicts. Cloud reads are grouped by provider and endpoint: tuya groups 2 actions into 1 chunks. Writeback follows lane updates and then the overall update: batch_011 -> batch_012. M6 found no counterexamples in the evaluated replay scenarios.
...
The first 8 BLE actions run serially to avoid shared-radio conflicts. Cloud reads are grouped by provider and endpoint: tuya groups 2 actions into 1 chunks. Writeback follows lane updates and then the overall update: batch_017 -> batch_018. M6 found no counterexamples in the evaluated replay scenarios.
...
The first 2 BLE actions run serially to avoid shared-radio conflicts. Cloud reads are grouped by provider and endpoint: tuya groups 2 actions into 1 chunks. Writeback follows lane updates and then the overall update: batch_007 -> batch_008. M6 found no counterexamples in the evaluated replay scenarios.
...
The first 8 BLE actions run serially to avoid shared-radio conflicts. Cloud reads are grouped by provider and endpoint: tuya groups 2 actions into 1 chunks. Local reads overlap other reads in batch_012. Writeback follows lane updates and then the overall update: batch_016 -> batch_017. M6 found no counterexamples in the evaluated replay scenarios.
...
- Final Schedule: `7` batches, max `5` parallel groups in one batch
- M6 Evidence: strict `6`, tolerant `6`, counterexamples `0`
...
Cloud reads are grouped by provider and endpoint: tuya groups 2 actions into 1 chunks. Local reads overlap other reads in batch_003. Writeback follows lane updates and then the overall update: batch_005 -> batch_006. M6 found no counterexamples in the evaluated replay scenarios.
...
Cloud reads are grouped by provider and endpoint: tuya groups 2 actions into 1 chunks. Writeback follows lane updates and then the overall update: batch_009 -> batch_010. M6 found no counterexamples in the evaluated replay scenarios.
...
The first 8 BLE actions run serially to avoid shared-radio conflicts. Local reads overlap other reads in batch_008. Writeback follows lane updates and then the overall update: batch_010 -> batch_011. M6 found no counterexamples in the evaluated replay scenarios.
...
The first 3 BLE actions run serially to avoid shared-radio conflicts. Local reads overlap other reads in batch_004. Writeback follows lane updates and then the overall update: batch_007 -> batch_008. M6 found no counterexamples in the evaluated replay scenarios.
...
The first 2 BLE actions run serially to avoid shared-radio conflicts. Local reads overlap other reads in batch_004. Writeback follows lane updates and then the overall update: batch_008 -> batch_009. M6 found no counterexamples in the evaluated replay scenarios.
...
Cloud reads are grouped by provider and endpoint: tuya groups 2 actions into 1 chunks. Writeback follows lane updates and then the overall update: batch_015 -> batch_016. M6 found no counterexamples in the evaluated replay scenarios.
...
The first 8 BLE actions run serially to avoid shared-radio conflicts. Local reads overlap other reads in batch_008. Writeback follows lane updates and then the overall update: batch_009 -> batch_010. M6 found no counterexamples in the evaluated replay scenarios.
...
- Final Schedule: `14` batches, max `5` parallel groups in one batch
- M6 Evidence: strict `6`, tolerant `6`, counterexamples `0`
...
Cloud reads are grouped by provider and endpoint: tuya groups 2 actions into 1 chunks. Local reads overlap other reads in batch_010. Writeback follows lane updates and then the overall update: batch_012 -> batch_013. M6 found no counterexamples in the evaluated replay scenarios.

...
async def test_clear_config_topic_disabled_entity(
    ...
    assert hass.states.get("sensor.abc123_sbfspot_12345") is None
    assert hass.states.get("sensor.abc123_sbfspot_12345_1") is not None
    assert hass.states.get("sensor.abc123_sbfspot_12345_2") is None
...
async def test_unique_id_collission_has_priority(
    ...
    assert hass.states.get("sensor.abc123_sbfspot_12345_1") is None
    assert hass.states.get("sensor.abc123_sbfspot_12345_2") is None
